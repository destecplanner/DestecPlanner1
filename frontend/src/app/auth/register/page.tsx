    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Hesabınızı Oluşturun</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-bold text-slate-500 ml-1">Şifre Tekrar</label>
          <Input 
            type="password" 
            placeholder="••••••••" 
